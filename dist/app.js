...
class ProjectState {
    ...
    addProject(title, description, numOfPeople, status) {
        const project = new Project(Math.random().toString(), title, description, numOfPeople, status);
...
class ProjectInput extends Component {
    ...
    submitHandler(event) {
        ...
        if (Array.isArray(userInput)) {
            ...
            projectState.addProject(title, desc, Number(people), ProjectStatus.Active);
        }
        this.clearInputs();
    }
    renderContent() { }
